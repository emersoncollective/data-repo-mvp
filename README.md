...
* Step 1 - Get Repo in Gdrive: 
    ...
    * Unzip the downloaded folder and then place it in a Google Drive folder. 
* Step 2 - Notebooks: 
...
* Step 3 - Open Notebook in Colab: 
    * Now we will open a notebook in Colab. Right click on the **CBP-Apprehensions.ipynb** and select Open with >> Google Colaboratory. 
